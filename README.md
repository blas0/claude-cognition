...
Clone this repo:
```bash
git clone https://github.com/blas0/claude-cognition.git
cd claude-cognition
```

## Usage with Claude Code

These output styles are designed to work with Claude Code. To use them:

1. Copy the content of either `simulated-cognition.md` or `process-cognition.md`
2. Paste it into your Claude Code custom instructions or project context
3. Run Claude Code with verbose output to see the full cognitive process:
...
- **Simulated Cognition**: Want to see AI reasoning that feels more human-like? Shows tension, revision, recursive thinking, and the messy process of arriving at answers.

- **Process Cognition**: Want to see the raw computational mechanics? Exposes pattern activation, interference, probability distributions, attention weights, and sampling strategies without the human metaphors.

Try both and see which one gives you better insight into how the AI is actually processing your requests.
